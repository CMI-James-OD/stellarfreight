...
export const metadata: Metadata = {
  title: "Policy",
  description: "StellarFreight privacy policy, terms of use, and payment policy.",
};
...
const sections = [
  ...
  },
  {
    ...
    content:
      "Shipment records are retained for 7 years to comply with trade documentation requirements. On-chain transaction records are permanent by virtue of the Stellar ledger's immutable history. You may request deletion of personal contact data by contacting support@stellarfreight.com.",
  },
  {
    title: "6. Security",
    content:
  ...
  },
  {
    title: "8. Contact",
    content:
      "For any policy questions or data requests, contact: policy@stellarfreight.com. For security disclosures: security@stellarfreight.com. We aim to respond to all policy inquiries within 5 business days.",
  },
];
...
export default function PolicyPage() {
  return (
    <>
      <main>
        <section className="relative overflow-hidden border-b border-border dark:border-white/[0.07] bg-background py-14 md:py-20">
          <HeroImageBackdrop src="/images/page-heroes/policy.jpg" alt="Shipping policy documents and operational paperwork" />

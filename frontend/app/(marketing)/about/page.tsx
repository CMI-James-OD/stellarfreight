...
import { proofStyleCopy } from "@/content/marketing";

export const metadata: Metadata = {
  title: "About",
  description:
    "StellarFreight is a Stellar-powered logistics platform on a mission to eliminate the friction of cross-border freight payments.",
};
...
const values = [
  {
    ...
    description:
      "Logistics runs on time. Payment delays kill deals, stall dispatches, and destroy trust. We built Stellar payments into our core because rapid confirmation is an operational requirement.",
  },
  {
    icon: Globe,
...
const milestones = [
  { year: "2022", event: "Founded with a mission to modernize cross-border freight payments." },
  { year: "2023", event: "Launched first Stellar payment integrations in controlled pilot flows." },
  {
    year: "2024",
    event: "Deployed Soroban escrow logic and expanded operational tracking instrumentation.",
  },
  {
    year: "2025",
    event: "Expanded pilot corridors and hardened tracking + escrow workflows for broader rollout.",
  },
];
    ...
    <>
      <main>
        ...
        <section className="relative overflow-hidden border-b border-border dark:border-white/[0.07] bg-background py-16 md:py-24">
          <HeroImageBackdrop src="/images/page-heroes/cargo-neutral.jpg" alt="Cargo vessel moving freight containers through open water" />
          ...
          <div className="relative mx-auto max-w-7xl px-4 md:px-6">
            ...
            <p className="mt-5 max-w-2xl text-lg text-muted-foreground">
              ...
              the 1970s. We built StellarFreight to change that, with Stellar at the centre.
            </p>
            <p className="mt-4 max-w-2xl text-sm text-muted-foreground">{proofStyleCopy.about}</p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl px-4 md:px-6">
            ...
            <div className="mt-6 space-y-5 text-muted-foreground leading-relaxed">
              <p>
                ...
                that involves multiple banks, multi-day clearing windows, fees that eat
              ...
              <p className="font-medium text-foreground">
                This is the problem StellarFreight was built to solve — using the Stellar network as our
                payment foundation.
              </p>
            </div>
          </div>

...
export const metadata: Metadata = {
  title: "Our Team",
  description: "The people behind StellarFreight's Stellar-powered logistics platform.",
};
    ...
    <>
      <main>
        ...
        <section className="relative overflow-hidden border-b border-border dark:border-white/[0.07] bg-background py-16 md:py-24">
          <HeroImageBackdrop src="/images/page-heroes/team.jpg" alt="Business team collaborating around a meeting table" />

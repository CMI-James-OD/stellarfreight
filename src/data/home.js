...
export const aboutus = [
  {
    icon: IoMdFingerPrint, // Store the function, not JSX
    title: "EXCELLENCE",
    description: "We meticulously assess our strategy every five years...",
  },
  {
    icon: IoGift,
    title: "FIRST CHOICE",
    description: "Trustway Logistics has remarkable clients worldwide...",
  },
  {
    icon: GiWorld,
    title: "A BIGGER WORLD",
    description: "Trustway Logistics contributes to a sustainable world...",
  },
];
